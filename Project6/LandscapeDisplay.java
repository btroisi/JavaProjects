...
public class LandscapeDisplay extends JFrame
{
    ...
    public LandscapeDisplay(Landscape scape, int scale)
    {
        ...
        this.canvas = new LandscapePanel( (int) this.scape.getRows() * this.gridScale,
    ...
    public static void main(String[] args) throws InterruptedException {
    	//Creates new customers and adds them to landscape
        Landscape scape = new Landscape(400,400,5);
      	Random gen = new Random();
      
        
        Spawner s = new Spawner(gen.nextInt(100),gen.nextInt(100),gen.nextInt(3),gen.nextInt(5));
        s.updateState(scape);
